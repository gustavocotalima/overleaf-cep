...
import { performPurgeUser, afterActions } from '../../../../util/user-actions'
...
function PurgeUsersButton() {
  ...
  const afterActions: AfterActions = { removeUserFromView }

  const handlePurgeUser = (user: User) => {
    return performPurgeUser(user, afterActions)
  }
